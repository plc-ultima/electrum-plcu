...
This guide explains how to build Electrum-PLCU binaries for macOS systems.
...
- The unix username should be `vagrant`, and `electrum-plcu` should be cloned directly
  to the user's home dir: `/Users/vagrant/electrum-plcu`.
...
- Make sure that you are building from a fresh clone of electrum-plcu
...
#### 2. Build Electrum-PLCU

    cd electrum-plcu
    ./contrib/osx/make_osx

This creates both a folder named Electrum-PLCU.app and the .dmg file.
