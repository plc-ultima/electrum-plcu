...
pushd $WINEPREFIX/drive_c/electrum-plcu
...
for i in ./locale/*; do
    dir="$WINEPREFIX/drive_c/electrum-plcu/electrum_plcu/$i/LC_MESSAGES"
    mkdir -p $dir
...
cd dist
mv electrum-plcu-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
