...
# - WWW_DIR: path to "electrum-plcu-web" git clone
#
...
# - update locale:
#     1. cd /opt/electrum-plcu-locale && ./update && push
...
VERSION=`python3 -c "import electrum_plcu; print(electrum_plcu.version.ELECTRUM_VERSION)"`
...
# create tarball
tarball="Electrum-PLCU-$VERSION.tar.gz"
...
# appimage
appimage="electrum-plcu-$REV-x86_64.AppImage"
...
# windows
win1="electrum-plcu-$REV.exe"
win2="electrum-plcu-$REV-portable.exe"
win3="electrum-plcu-$REV-setup.exe"
...
# android
apk1="Electrum-PLCU-$VERSION.0-armeabi-v7a-release.apk"
apk1_unsigned="Electrum-PLCU-$VERSION.0-armeabi-v7a-release-unsigned.apk"
apk2="Electrum-PLCU-$VERSION.0-arm64-v8a-release.apk"
apk2_unsigned="Electrum-PLCU-$VERSION.0-arm64-v8a-release-unsigned.apk"
