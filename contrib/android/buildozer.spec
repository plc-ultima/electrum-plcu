...
# (str) Package name
package.name = Electrum_PLCU

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_plcu
...
source.exclude_dirs = bin, build, dist, contrib,
    ...
    electrum_plcu/gui/kivy/theming/light,
    packages/qdarkstyle,
    packages/qtpy
...
version.filename = %(source.dir)s/electrum_plcu/version.py
...
presplash.filename = %(source.dir)s/electrum_plcu/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_plcu/gui/icons/android_electrum_icon_legacy.png
icon.adaptive_foreground.filename = %(source.dir)s/electrum_plcu/gui/icons/android_electrum_icon_foreground.png
icon.adaptive_background.filename = %(source.dir)s/electrum_plcu/gui/icons/android_electrum_icon_background.png
...
android.add_src = electrum_plcu/gui/kivy/data/java-classes/
