...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="$CONTRIB_APPIMAGE/fresh_clone/electrum-plcu" && \
...
sudo docker run -it \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/electrum-plcu \
    --rm \
    --workdir /opt/electrum-plcu/contrib/build-linux/appimage \
