...
from electrum_plcu import constants, blockchain
from electrum_plcu.simple_config import SimpleConfig
from electrum_plcu.blockchain import Blockchain, deserialize_header, hash_header
from electrum_plcu.util import bh2u, bfh, make_dir
...
class TestVerifyHeader(ElectrumTestCase):
    ...
    # Data for PLC Ultima block header #100.
