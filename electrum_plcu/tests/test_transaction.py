...
from electrum_plcu import transaction, bitcoin
from electrum_plcu.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
...
from electrum_plcu.bitcoin import (deserialize_privkey, opcodes,
