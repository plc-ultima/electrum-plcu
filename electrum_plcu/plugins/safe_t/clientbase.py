...
from electrum_plcu.util import UserCancelled
from electrum_plcu.keystore import bip39_normalize_passphrase
from electrum_plcu.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32
from electrum_plcu.logging import Logger
from electrum_plcu.plugin import runs_in_hwd_thread
from electrum_plcu.plugins.hw_wallet.plugin import HardwareClientBase, HardwareHandlerBase
    ...
    def callback_PassphraseRequest(self, req):
        ...
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the plcultimas in the wallet.").format(self.device)
        else:
