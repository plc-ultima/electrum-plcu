...
from electrum_plcu import ecc, constants
from electrum_plcu import bip32
from electrum_plcu.crypto import hash_160
from electrum_plcu.bitcoin import int_to_hex, var_int, is_segwit_script_type, is_b58_address
from electrum_plcu.bip32 import BIP32Node, convert_bip32_intpath_to_strpath
...
from electrum_plcu.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_plcu.base_wizard import ScriptTypeNotSupported
from electrum_plcu.logging import get_logger
from electrum_plcu.plugin import runs_in_hwd_thread, Device
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "PLC Ultima" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in PLC Ultima mode")) from e
                raise e
