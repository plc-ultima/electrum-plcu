...
from electrum_plcu.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_plcu.bitcoin import public_key_to_p2pkh
from electrum_plcu.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_plcu import ecc
from electrum_plcu.ecc import msg_magic
from electrum_plcu.wallet import Standard_Wallet
from electrum_plcu import constants
from electrum_plcu.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_plcu.i18n import _
from electrum_plcu.keystore import Hardware_KeyStore
from electrum_plcu.util import to_string, UserCancelled, UserFacingException, bfh
...
from electrum_plcu.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-PLCU-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
