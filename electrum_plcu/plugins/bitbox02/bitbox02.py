...
from electrum_plcu import bip32, constants
from electrum_plcu.i18n import _
from electrum_plcu.keystore import Hardware_KeyStore
from electrum_plcu.transaction import PartialTransaction
from electrum_plcu.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from electrum_plcu.util import bh2u, UserFacingException
from electrum_plcu.base_wizard import ScriptTypeNotSupported, BaseWizard
from electrum_plcu.logging import get_logger
from electrum_plcu.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_plcu.simple_config import SimpleConfig
from electrum_plcu.json_db import StoredDict
from electrum_plcu.storage import get_derivation_used_for_hw_device_encryption
from electrum_plcu.bitcoin import OnchainOutputType

import electrum_plcu.bitcoin as bitcoin
import electrum_plcu.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def coin_network_from_electrum_network(self) -> int:
        if constants.net.TESTNET:
            return bitbox02.btc.TPLCU
        return bitbox02.btc.PLCU
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            if coin_network == bitbox02.btc.PLCU:
    ...
    def _get_coin(self):
        return bitbox02.btc.TPLCU if constants.net.TESTNET else bitbox02.btc.PLCU
