...
from electrum_plcu import WalletStorage, Wallet
from electrum_plcu.wallet_db import WalletDB
from electrum_plcu.util import format_satoshis
from electrum_plcu.bitcoin import is_address, COIN
from electrum_plcu.transaction import PartialTxOutput
from electrum_plcu.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui(BaseElectrumGui):
    ...
    def __init__(self, *, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-plcu create'")
            exit()
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid PLC Ultima address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-plcu setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-plcu setconfig' to change your settings")
        return True
