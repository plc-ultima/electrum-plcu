...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_plcu.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_plcu"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_plcu:externalType",
                '',
                data)
        return extRecord
