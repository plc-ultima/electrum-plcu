...
from electrum_plcu.util import is_valid_email
...
#:import _ electrum_plcu.gui.kivy.i18n._
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_plcu.mnemonic import Mnemonic
        from electrum_plcu.old_mnemonic import wordlist as old_wordlist
    ...
    def update_next_button(self):
        from electrum_plcu.keystore import bip39_is_checksum_valid
        text = self.get_text()
        if self.is_bip39:
