...
from electrum_plcu.util import base_units_list
from electrum_plcu.i18n import languages
from electrum_plcu.gui.kivy.i18n import _
from electrum_plcu.plugin import run_hook
from electrum_plcu import coinchooser
...
#:import messages electrum_plcu.gui.messages
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for PLC Ultima amounts.")
