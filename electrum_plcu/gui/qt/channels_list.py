...
from electrum_plcu.util import bh2u, NotEnoughFunds, NoDynamicFeeEstimates
from electrum_plcu.i18n import _
from electrum_plcu.lnchannel import AbstractChannel, PeerState, ChannelBackup, Channel, ChannelState
from electrum_plcu.wallet import Abstract_Wallet
from electrum_plcu.lnutil import LOCAL, REMOTE, format_short_channel_id, LN_MAX_FUNDING_SAT
from electrum_plcu.lnworker import LNWallet
...
class ChannelsList(MyTreeView):
    ...
    def get_toolbar(self):
        ...
        # PLC Ultima: disable swap for now
    ...
    def new_channel_dialog(self):
        ...
        if self.parent.network.channel_db:
            ...
            from electrum_plcu.lnworker import hardcoded_trampoline_nodes
