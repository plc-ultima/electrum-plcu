...
from electrum_plcu.util import print_msg, create_and_start_event_loop
from electrum_plcu.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <plcultima_address>")
    sys.exit(1)
