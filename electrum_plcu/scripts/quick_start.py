...
from electrum_plcu.wallet import Wallet, create_new_wallet
from electrum_plcu.wallet_db import WalletDB
from electrum_plcu.commands import Commands
from electrum_plcu.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-plcu/testnet as datadir
